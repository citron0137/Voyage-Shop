...
class CouponEventService(
     ...
     * @return 생성된 쿠폰 이벤트
     * @throws CouponEventException.InvalidBenefitMethod 유효하지 않은 혜택 방식인 경우
     */
    fun createCouponEventWithValidation(criteria: CouponEventCriteria.Create): CouponEvent {
        val benefitMethod = try {
            when (criteria.benefitMethod) {
                ...
                else -> throw CouponEventException.InvalidBenefitMethod(criteria.benefitMethod)
            }
        } catch (e: IllegalArgumentException) {
            throw CouponEventException.InvalidBenefitMethod(criteria.benefitMethod)
        }
    ...
    fun getCouponEvent(id: String): CouponEvent {
        return repository.findById(id)
            ?: throw CouponEventException.NotFound(id)
    }
     ...
     */
    private fun convertToCouponBenefitMethod(benefitMethod: CouponEventBenefitMethod): CouponBenefitMethod {
